...
// WorkoutStore defines methods for managing workout data, including creation, retrieval, and updates in the system.
...
VAlUES ($1, $2, $3, $4, $5, $6, $7, $8)`
		_, err = tx.Exec(query,
			...
			entry.Reps,
			entry.DurationSeconds,
			entry.Weight, entry.Notes, entry.OrderIndex)
		if err != nil {
			return err
		}
	}
